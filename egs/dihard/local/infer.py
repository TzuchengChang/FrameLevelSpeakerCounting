...
parser.add_argument("--checkpoint_name", type=str, default="checkpoints/epoch=12-step=7878.ckpt")
parser.add_argument("--wav_dir", type=str, default="F:/data/DIHARD3/preprocess/eval")
parser.add_argument("--out_dir", type=str, default="../exp/tcn/preds/checkpoints/epoch=12-step=7878.ckpt")
