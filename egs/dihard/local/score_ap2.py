...
parser.add_argument("--preds_dir", type=str, default=r"..\exp\tcn\preds\checkpoints\epoch=12-step=7878.ckpt")
...
if __name__ == "__main__":
    ...
    with open('output.csv', 'w', newline='') as csvfile:
        ...
        csvwriter.writerow(['Name'] + ['Data{}'.format(i) for i in range(1, 10)])
        for sess in diarization.keys():
            ...
            flattened_data = cm.flatten()
            csvwriter.writerow([sess] + flattened_data.tolist())
