...
parser.add_argument("--checkpoint_name", type=str, default="checkpoints/epoch=77-step=71214.ckpt")
parser.add_argument("--wav_dir", type=str, default="F:/data/ami/amicorpus")
parser.add_argument("--out_dir", type=str, default="../exp/tcn/preds/checkpoints/epoch=77-step=71214.ckpt")
