...
parser.add_argument("--preds_dir", type=str, default=r"..\exp\tcn\preds\checkpoints\epoch=77-step=71214.ckpt")
...
def score(preds, target_vector):
    target_vector[target_vector >= 4] = 4
